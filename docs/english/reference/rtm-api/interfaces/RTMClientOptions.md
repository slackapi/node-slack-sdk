[@slack/rtm-api](../index.md) / RTMClientOptions

# Interface: RTMClientOptions

Defined in: [packages/rtm-api/src/RTMClient.ts:717](https://github.com/slackapi/node-slack-sdk/blob/main/packages/rtm-api/src/RTMClient.ts#L717)
