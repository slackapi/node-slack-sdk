[@slack/rtm-api](../index.md) / RTMSendWhileDisconnectedError

# Interface: RTMSendWhileDisconnectedError

Defined in: [src/errors.ts:47](https://github.com/slackapi/node-slack-sdk/blob/main/packages/rtm-api/src/errors.ts#L47)
...
Defined in: [src/errors.ts:48](https://github.com/slackapi/node-slack-sdk/blob/main/packages/rtm-api/src/errors.ts#L48)
