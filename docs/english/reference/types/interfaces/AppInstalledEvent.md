[@slack/types](../index.md) / AppInstalledEvent
...
Defined in: [events/app.ts:85](https://github.com/slackapi/node-slack-sdk/blob/main/packages/types/src/events/app.ts#L85)
