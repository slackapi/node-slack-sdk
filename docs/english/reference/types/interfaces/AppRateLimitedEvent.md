[@slack/types](../index.md) / AppRateLimitedEvent
...
Defined in: [events/app.ts:212](https://github.com/slackapi/node-slack-sdk/blob/main/packages/types/src/events/app.ts#L212)
