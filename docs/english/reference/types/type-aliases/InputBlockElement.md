[@slack/types](../index.md) / InputBlockElement
...
Defined in: [block-kit/blocks.ts:398](https://github.com/slackapi/node-slack-sdk/blob/main/packages/types/src/block-kit/blocks.ts#L398)
