[@slack/types](../index.md) / AllMessageEvents
...
Defined in: [events/message.ts:8](https://github.com/slackapi/node-slack-sdk/blob/main/packages/types/src/events/message.ts#L8)
