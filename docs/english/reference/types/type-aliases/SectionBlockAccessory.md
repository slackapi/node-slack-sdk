[@slack/types](../index.md) / SectionBlockAccessory
...
Defined in: [block-kit/blocks.ts:326](https://github.com/slackapi/node-slack-sdk/blob/main/packages/types/src/block-kit/blocks.ts#L326)
