...
Defined in: [src/errors.ts:36](https://github.com/slackapi/node-slack-sdk/blob/main/packages/oauth/src/errors.ts#L36)
...
Defined in: [src/errors.ts:37](https://github.com/slackapi/node-slack-sdk/blob/main/packages/oauth/src/errors.ts#L37)
