[@slack/webhook](../index.md) / retryPolicies
...
Defined in: [packages/webhook/src/retry-policies.ts:35](https://github.com/slackapi/node-slack-sdk/blob/main/packages/webhook/src/retry-policies.ts#L35)
