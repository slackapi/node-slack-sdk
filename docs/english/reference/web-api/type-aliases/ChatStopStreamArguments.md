...
Defined in: [packages/web-api/src/types/request/chat.ts:280](https://github.com/slackapi/node-slack-sdk/blob/main/packages/web-api/src/types/request/chat.ts#L280)
