...
Defined in: [packages/web-api/src/types/request/admin/teams.ts:8](https://github.com/slackapi/node-slack-sdk/blob/main/packages/web-api/src/types/request/admin/teams.ts#L8)
