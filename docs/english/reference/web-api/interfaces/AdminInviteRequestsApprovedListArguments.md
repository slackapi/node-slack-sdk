[@slack/web-api](../index.md) / AdminInviteRequestsApprovedListArguments

# Interface: AdminInviteRequestsApprovedListArguments

Defined in: [packages/web-api/src/types/request/admin/inviteRequests.ts:15](https://github.com/slackapi/node-slack-sdk/blob/main/packages/web-api/src/types/request/admin/inviteRequests.ts#L15)
