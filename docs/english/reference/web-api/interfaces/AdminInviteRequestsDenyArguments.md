...
Defined in: [packages/web-api/src/types/request/admin/inviteRequests.ts:27](https://github.com/slackapi/node-slack-sdk/blob/main/packages/web-api/src/types/request/admin/inviteRequests.ts#L27)
