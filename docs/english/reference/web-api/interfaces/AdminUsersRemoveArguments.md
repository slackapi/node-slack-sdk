...
Defined in: [packages/web-api/src/types/request/admin/users.ts:116](https://github.com/slackapi/node-slack-sdk/blob/main/packages/web-api/src/types/request/admin/users.ts#L116)
