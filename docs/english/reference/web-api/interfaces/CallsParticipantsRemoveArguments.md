[@slack/web-api](../index.md) / CallsParticipantsRemoveArguments

# Interface: CallsParticipantsRemoveArguments

Defined in: [packages/web-api/src/types/request/calls.ts:63](https://github.com/slackapi/node-slack-sdk/blob/main/packages/web-api/src/types/request/calls.ts#L63)
