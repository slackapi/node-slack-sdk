[@slack/web-api](../index.md) / EntityTypedField

# Interface: EntityTypedField

Defined in: packages/types/dist/message-metadata.d.ts:167
...
Defined in: packages/types/dist/message-metadata.d.ts:168
