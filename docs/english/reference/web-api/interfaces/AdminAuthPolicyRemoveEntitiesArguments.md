...
Defined in: [packages/web-api/src/types/request/admin/auth.ts:27](https://github.com/slackapi/node-slack-sdk/blob/main/packages/web-api/src/types/request/admin/auth.ts#L27)
