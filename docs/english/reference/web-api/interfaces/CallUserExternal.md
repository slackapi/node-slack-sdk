[@slack/web-api](../index.md) / CallUserExternal

# Interface: CallUserExternal

Defined in: packages/types/dist/calls.d.ts:12
...
Defined in: packages/types/dist/calls.d.ts:20
...
Defined in: packages/types/dist/calls.d.ts:16
