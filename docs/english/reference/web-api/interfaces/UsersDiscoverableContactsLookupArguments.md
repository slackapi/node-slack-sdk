...
Defined in: [packages/web-api/src/types/request/users.ts:28](https://github.com/slackapi/node-slack-sdk/blob/main/packages/web-api/src/types/request/users.ts#L28)
