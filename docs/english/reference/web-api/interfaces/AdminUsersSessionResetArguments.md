...
Defined in: [packages/web-api/src/types/request/admin/users.ts:136](https://github.com/slackapi/node-slack-sdk/blob/main/packages/web-api/src/types/request/admin/users.ts#L136)
