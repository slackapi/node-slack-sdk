 ...
 */
var RETRY_FOREVER_EXPONENTIAL_CAPPED = Object.assign({
  maxTimeout: 30 * 60 * 1000
}, RETRY_FOREVER_EXPONENTIAL);
 ...
 */
var RETRY_FOREVER_EXPONENTIAL_CAPPED_RANDOM = Object.assign({
  randomize: true
}, RETRY_FOREVER_EXPONENTIAL_CAPPED);
