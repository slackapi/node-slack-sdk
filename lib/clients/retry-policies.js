...
module.exports.retryPolicyFromOptions = function retryPolicyFromOptions(opts) {
  ...
  if (!opts.maxReconnectionAttempts || !opts.reconnectionBackoff) {
    return policy;
  }

  policy = {};
  policy.retries = opts.maxReconnectionAttempts || 10;
  policy.minTimeout = policy.maxTimeout = opts.reconnectionBackoff || 3000;
  return policy;
};
