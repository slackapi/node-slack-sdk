...
/**
 * Helper for deleting a sent message via the 'chat.delete' API call
 * @param message {object} message The message object to be deleted,
 * see /lib/clients/web/facets/chat.js for more details
 * @param {Function=} optCb Optional callback
 */
RTMClient.prototype.deleteMessage = function deleteMessage(message, optCb) {
  return this._chat.delete(message.ts, message.channel, message.text, message.opts, optCb);
};
