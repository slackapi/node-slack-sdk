 ...
 *   - WS_OPENING             the client is opening a socket at the supplied URL
 *   - WS_OPENED              the client has opened the socket at the supplied URL
 *   - RTM_CONNECTION_OPENED  the remote server has acked the socket and sent a `hello`, the
