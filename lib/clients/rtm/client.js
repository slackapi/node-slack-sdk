 ...
 * @deprecated @param {Number} opts.maxReconnectionAttempts Use retryConfig instead
 * @deprecated @param {Number} opts.reconnectionBackoff     Use retryConfig instead
...
/**
 * Attempts to reconnect to the websocket by retrying {@link rtm.start}.
 */
