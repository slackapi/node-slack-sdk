...
package's website](https://docs.slack.dev/node-slack-sdk/rtm-api).
...
detail [on the documentation website](https://docs.slack.dev/node-slack-sdk/rtm-api/#presence).
