...
describe('error classes', () => {
  describe('SMWebsocketError', () => {
    it('should be an instance of Error, SlackSocketModeError, and SMWebsocketError', () => {
      const original = new Error('connection reset');
      const err = new SMWebsocketError(original);
      assert.ok(err instanceof Error);
      assert.ok(err instanceof SlackSocketModeError);
  ...
  describe('SMPlatformError', () => {
    it('should be an instance of Error, SlackSocketModeError, and SMPlatformError', () => {
  ...
  describe('SMNoReplyReceivedError', () => {
    it('should be an instance of Error, SlackSocketModeError, and SMNoReplyReceivedError', () => {
  ...
  describe('SMSendWhileDisconnectedError', () => {
    it('should be an instance of Error, SlackSocketModeError, and SMSendWhileDisconnectedError', () => {
  ...
  describe('SMSendWhileNotReadyError', () => {
    it('should be an instance of Error, SlackSocketModeError, and SMSendWhileNotReadyError', () => {
