...
export interface MrkdwnElement {
  ...
  /**
   * The text for the block. This field accepts any of the standard [text formatting markup](https://api.slack.com/messaging/composing/formatting).
   */
  text: string;
   ...
   * Using a value of false will skip any preprocessing of this nature, although you can still include [manual parsing strings](https://api.slack.com/messaging/composing/formatting#advanced).
   */
  verbatim?: boolean;
}
...
export interface Action {
  ...
  /**
   * An identifier for the action triggered when a menu option is selected. You can use this when you receive an interaction payload to [identify the source of the action](https://api.slack.com/messaging/interactivity/enabling#understanding-payloads). Should be unique among all other action_ids used elsewhere by your app. Maximum length for this field is 255 characters.
   */
  action_id?: string;
 ...
 *
 * To use interactive elements like this, you will need to make some changes to prepare your app. Read our [guide to enabling interactivity](https://api.slack.com/messaging/interactivity/enabling).
 *
...
/**
 * Block elements can be used inside of `section`, `context`, and `actions` [layout blocks](https://api.slack.com/reference/messaging/blocks).
 *
 * Our guide to [composing rich message layouts](https://api.slack.com/messaging/composing/layouts) shows you where and how to add blocks to messages.
 *
 * Finally, the [enabling interactivity guide](https://api.slack.com/messaging/interactivity/enabling) will help you adjust your app to allow for the use of these interactive components.
 *
