...
package's website](https://docs.slack.dev/node-slack-sdk/web-api).
...
TypeScript](https://docs.slack.dev/node-slack-sdk/typescript) with this package in the documentation website.
...
* `ErrorCode.RateLimitedError`: The Web API cannot fulfill the API method call because your app has made too many
  ...
  again. See [the documentation on rate limit handling](https://docs.slack.dev/node-slack-sdk/web-api/#rate-limits) to
...
The [documentation website](https://docs.slack.dev/node-slack-sdk/web-api) has information about these additional features of
the `WebClient`:
