...
expectError(web.admin.conversations.create({
...
expectError(web.admin.conversations.invite({
...
expectError(web.admin.conversations.lookup({
...
expectError(web.admin.conversations.rename({
...
expectError(web.admin.conversations.restrictAccess.addGroup({
...
expectError(web.admin.conversations.restrictAccess.removeGroup({
  channel_id: 'C1234', // missing group_id
}));
expectError(web.admin.conversations.restrictAccess.removeGroup({
  group_id: 'G1234', // missing channel_id
...
expectError(web.admin.conversations.setConversationPrefs({
