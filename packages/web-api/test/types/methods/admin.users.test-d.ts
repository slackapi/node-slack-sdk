...
expectError(
  web.admin.users.session.clearSettings({
    user_ids: [],
  }),
...
expectError(
  web.admin.users.session.getSettings({
    user_ids: [],
  }),
); // must provide at least one user_id
// -- happy path
...
expectError(
  web.admin.users.session.invalidate({
...
expectError(
  web.admin.users.session.resetBulk({
    user_ids: [],
  }),
); // must provide at least one user_id
// -- happy path
...
expectError(
  web.admin.users.session.setSettings({
    user_ids: [],
  }),
); // must provide at least one user_id
// -- happy path
