...
export abstract class Methods extends EventEmitter<WebClientEvent> {
  ...
  public readonly apps = {
    ...
    permissions: {
      info: bindApiCall<AppsPermissionsInfoArguments, WebAPICallResult>(this, 'apps.permissions.info'),
      request: bindApiCall<AppsPermissionsRequestArguments, WebAPICallResult>(this, 'apps.permissions.request'),
      resources: {
        list: bindApiCall<AppsPermissionsResourcesListArguments, WebAPICallResult>(
          this, 'apps.permissions.resources.list'),
      },
      scopes: {
        list: bindApiCall<AppsPermissionsScopesListArguments, WebAPICallResult>(this, 'apps.permissions.scopes.list'),
      },
      users: {
        list: bindApiCall<AppsPermissionsUsersListArguments, WebAPICallResult>(this, 'apps.permissions.users.list'),
        request: bindApiCall<AppsPermissionsUsersRequestArguments, WebAPICallResult>(
          this, 'apps.permissions.users.request'),
      },
    },
...
export interface AdminConversationsDisconnectSharedArguments extends WebAPICallOptions, TokenOverridable {
  channel_id: string;
  leaving_team_ids?: string | string[];
}
...
export interface AdminConversationsSearchArguments
  extends WebAPICallOptions, TokenOverridable, CursorPaginationEnabled {
  query?: string;
  search_channel_types?: string | string[];
...
export interface AppsPermissionsInfoArguments extends WebAPICallOptions, TokenOverridable {}
export interface AppsPermissionsRequestArguments extends WebAPICallOptions, TokenOverridable {
  scopes: string[];
  trigger_id: 'string';
}
export interface AppsPermissionsResourcesListArguments
  extends WebAPICallOptions, TokenOverridable, CursorPaginationEnabled {}
cursorPaginationEnabledMethods.add('apps.permissions.resources.list');
export interface AppsPermissionsScopesListArguments extends WebAPICallOptions, TokenOverridable {}
export interface AppsPermissionsUsersListArguments
  extends WebAPICallOptions, TokenOverridable, CursorPaginationEnabled {}
cursorPaginationEnabledMethods.add('apps.permissions.users.list');
export interface AppsPermissionsUsersRequestArguments extends WebAPICallOptions, TokenOverridable {
  scopes: string[];
  trigger_id: string;
  user: string;
}
